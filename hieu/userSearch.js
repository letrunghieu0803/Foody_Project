...
//                 window.location.href = "C:/Users/PC/Desktop/Foody_Project/hieu/userSearchFocus.html";
//             }
//         });
//     });


let id = window.localStorage.getItem("searchValue")
db.collection("userSignIn").where("lastname", "==", id).get()
    .then(data => {
        data.forEach(element => {
            console.log(element.data().ten);
            banhMy.innerHTML += `
